...
const ListView$1 = lazy(() => import("./ListView-_ZpKHv_E.mjs"));
const RecursivePath = () => {
...
const ListView = lazy(() => import("./ListView-_ZpKHv_E.mjs"));
const App = () => {
  const { formatMessage } = useIntl();
...
//# sourceMappingURL=index-kZn-yheC.mjs.map
