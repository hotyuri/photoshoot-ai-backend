...
import { p as useEnterprise, j as useTypedSelector, x as isBaseQueryError } from "./index-uCIlbOdV.mjs";
...
import { u as useWebhooks } from "./useWebhooks-mNdei-OL.mjs";
...
const WebhookForm = ({
  ...
  const EventTable = useEnterprise(
    EventTableCE,
    async () => (await import("./EventsTable-i-9TDKBd.mjs")).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-1EtUZ_tq.mjs.map
