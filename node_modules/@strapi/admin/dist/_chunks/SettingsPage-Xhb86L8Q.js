...
const AuthenticatedApp = require("./AuthenticatedApp-NwGWm2ih.js");
...
const useSettingsMenu = () => {
  ...
  const { admin: adminLinks, global: globalLinks } = index.useEnterprise(
    ceLinks,
    async () => (await Promise.resolve().then(() => require("./constants-Kqj6p2F4.js"))).SETTINGS_LINKS_EE(),
    {
...
const ROUTES_CE = [
  {
    async Component() {
      const { ProtectedListPage } = await Promise.resolve().then(() => require("./ListPage-jAEDbS4F.js"));
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await Promise.resolve().then(() => require("./CreatePage-C2kTsfl3.js"));
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require("./EditPage-89bN0dP7.js"));
  ...
  {
    async Component() {
      const { ProtectedListPage } = await Promise.resolve().then(() => require("./ListPage-iMVon91v.js"));
      return ProtectedListPage;
    },
    to: "/settings/users",
    exact: true
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require("./EditPage-719UMLLZ.js"));
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedCreatePage } = await Promise.resolve().then(() => require("./CreatePage-ysJgJ-gB.js"));
      return ProtectedCreatePage;
    },
  ...
  {
    async Component() {
      const { ProtectedEditPage } = await Promise.resolve().then(() => require("./EditPage-J1g9GCi_.js")).then((n) => n.EditPage$1);
      return ProtectedEditPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListPage } = await Promise.resolve().then(() => require("./ListPage-sAkwL2Wg.js"));
      return ProtectedListPage;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await Promise.resolve().then(() => require("./ListView--2S8Bh5Z.js"));
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await Promise.resolve().then(() => require("./CreateView-pWsNaVZf.js"));
  ...
  {
    async Component() {
      const { ProtectedEditView } = await Promise.resolve().then(() => require("./EditViewPage-KosKrHpe.js"));
  ...
  {
    async Component() {
      const { ProtectedCreateView } = await Promise.resolve().then(() => require("./CreateView-nz15614b.js"));
      return ProtectedCreateView;
    },
  ...
  {
    async Component() {
      const { ProtectedListView } = await Promise.resolve().then(() => require("./ListView-5UC1t0D2.js"));
      return ProtectedListView;
    },
  ...
  {
    async Component() {
      const { ProtectedEditView } = await Promise.resolve().then(() => require("./EditView-Gbs0MgLG.js"));
      return ProtectedEditView;
    },
...
const ApplicationInfoPage = () => {
  ...
  const AdminSeatInfo = index.useEnterprise(
    AdminSeatInfoCE,
    async () => (await Promise.resolve().then(() => require("./AdminSeatInfo-idYGK_rQ.js"))).AdminSeatInfoEE
  );
  const {
...
const SettingsPage = () => {
  ...
  const routes = index.useEnterprise(
    ROUTES_CE,
    async () => (await Promise.resolve().then(() => require("./constants-sY2OlTRI.js"))).ROUTES_EE,
    {
...
//# sourceMappingURL=SettingsPage-Xhb86L8Q.js.map
