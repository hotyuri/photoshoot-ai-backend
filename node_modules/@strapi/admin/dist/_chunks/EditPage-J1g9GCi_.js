...
const useWebhooks = require("./useWebhooks-mRRXRx5w.js");
...
const WebhookForm = ({
  ...
  const EventTable = index.useEnterprise(
    EventTableCE,
    async () => (await Promise.resolve().then(() => require("./EventsTable-OuKWTYd5.js"))).EventsTableEE
  );
...
//# sourceMappingURL=EditPage-J1g9GCi_.js.map
