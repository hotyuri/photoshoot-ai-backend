...
const dependencies = {
  ...
  "@strapi/icons": "1.19.0",
  "@strapi/provider-upload-local": "4.25.20",
...
const index = {
  register(app) {
    app.addMenuLink({
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-5Dlmcks2.js"));
        return component;
      }
    });
  ...
  bootstrap(app) {
    app.addSettingsLink("global", {
      ...
      async Component() {
        const component = await Promise.resolve().then(() => require("./index-kFHP2KuB.js"));
        return component;
      },
...
//# sourceMappingURL=index-Veq9MQjm.js.map
